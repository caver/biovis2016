...
When a corresponding secondary structure  (bead with same color) is found 

The algorithm ends when both protein chains are processed.

In each step the algorithm compares the secodary structures f

 and uses per-step approach. 
